...
# ASSOCIATION DES COULEURS AUX TROUBLES :
colors = {
...
disorder_bar_fig.update_layout(
    ...
    xaxis=dict(
        ...
        zeroline=False,
        title=dict(
            text='<i>Taux de prévalence moyens mondiaux des troubles de santé mentale</i>',
            font=dict(size=11),
            standoff=40
        )
    )
...
# TRACÉ DU GRAPHIQUE EN LIGNE (GRAPHIQUE AU SURVOL) :
...
# ASSOCIATION DES LABELS AUX DF CORRESPONDANTS :
graph_functions = {
